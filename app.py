...
def handle_message(event):
    ...
    if event.message.text == "信用卡flex":
        ...
        flex_template = FlexSendMessage(alt_text="請用手機觀看", contents=bubble)
        ...
        bubble = BubbleContainer(
            ...
            body=BoxComponent(
                ...
                contents=[
                    ...
                    TextComponent(text='功能推薦', weight='bold', size='xl'),
        ...
        bubble_1 = BubbleContainer(
            ...
            body=BoxComponent(
                ...
                contents=[
                    # title
                    TextComponent(text='recommendation1', weight='bold', size='xl'),
                    # review
                    BoxComponent(
                        layout='baseline',
                        margin='md',
        ...
        bubble_2 = BubbleContainer(
            ...
            body=BoxComponent(
                ...
                contents=[
                    # title
                    TextComponent(text='recommendation2', weight='bold', size='xl'),
                    # review
                    BoxComponent(
                        layout='baseline',
                        margin='md',
        ...
        bubble_3 = BubbleContainer(
            ...
            body=BoxComponent(
                ...
                contents=[
                    # title
                    TextComponent(text='recommendation3', weight='bold', size='xl'),
                    # review
                    BoxComponent(
                        layout='baseline',
                        margin='md',
        ...
        bubble_4 = BubbleContainer(
            ...
            body=BoxComponent(
                ...
                contents=[
                    # title
                    TextComponent(text='recommendation4', weight='bold', size='xl'),
                    # review
                    BoxComponent(
                        layout='baseline',
                        margin='md',
        ...
        bubble_5 = BubbleContainer(
            ...
            body=BoxComponent(
                ...
                contents=[
                    # title
                    TextComponent(text='recommendation5', weight='bold', size='xl'),
                    # review
                    BoxComponent(
                        layout='baseline',
                        margin='md',
        ...
        newbubble = BubbleContainer(
            body=BoxComponent(layout='vertical', contents=[
                ...
                ButtonComponent(action=MessageAction(label='分析後的喜好推薦', text='分析後的喜好推薦')),
        ...
        Carousel = CarouselContainer(BubbleContainer(body=BoxComponent(layout='vertical',
          contents=[
